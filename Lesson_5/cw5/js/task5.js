...
function enough(seats, people, station) {
    if (seats >= people + station) {
        ...
        var result = (people + station) - seats;
        return result + " Не поместятся " + result +" из " + (people + station); 
    }
}
console.log(enough(10, 5, 5)); // 0, так как вместятся все
console.log(enough(100, 60, 50));// 10, Не поместятся 10 из 50
